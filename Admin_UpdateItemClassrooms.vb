...
Public Class Admin_UpdateItemClassrooms
    ...
    Private Sub btn_UpdatingItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_UpdatingItem.Click
        ...
        Dim id, name, condition, statusDelete, availability, dates As String
        ...
        Using cmd1 As New OleDbCommand("UPDATE tbl_Classrooms SET Room='" & name & "',Condition='" & condition & "',StatusDelete='" & statusDelete & "', Availability='" & availability & "' WHERE  ID='" & id & "'", connection)
