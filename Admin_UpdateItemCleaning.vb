...
Public Class Admin_UpdateItemCleaning
    'FOR CLEANING UPDATE BUTTON
    Private Sub btn_UpdatingItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_UpdatingItem.Click
        ...
        Using cmd1 As New OleDbCommand("UPDATE tbl_CleaningMaterials SET EquipmentDetails='" & details & "',Equipments='" & name & "',Condition='" & condition & "',Cost='" & cost & "',StatusDelete='" & statusDelete & "', Availability='" & availability & "' WHERE  ID='" & id & "'", connection)
